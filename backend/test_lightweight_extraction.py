"""
Test script for the Lightweight Data Extraction Agent
"""
...
from backend.lightweight_data_extraction_agent import LightweightDataExtractionAgent

def test_lightweight_data_extraction_agent():
    """Test the Lightweight Data Extraction Agent functionality"""
    data_path = "./data/manektech_info.md"
    
    print("Initializing Lightweight Data Extraction Agent...")
...
if __name__ == "__main__":
    test_lightweight_data_extraction_agent()
